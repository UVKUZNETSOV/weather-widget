  ...
  return (
    <div className="chart flex flex-col items-center h-full">
      ...
      <div className="flex flex-col items-center text-white h-full justify-end py-10 gap-2 max-[460px]:gap-1">
        <img src={icon} alt="" />
        <h1 className="text-8xl max-[460px]:text-6xl">{Math.floor(degrees)}º</h1>
        <h2 className="text-4xl flex flex-col text-center">{city}<span className="text-2xl">{country}</span></h2>
      </div>
    </div>
  );
};
